...
- Tim: migraties 004 en 005 plakken in de Supabase SQL Editor (staan ook op het klembord); zonder 004/005 werken kluis en review niet (goedkeuren werkt wel).
- Tim: de drie nieuwe functies testen met een testklant: bestand uploaden (klant en studio), versie publiceren, opmerking met tijdcode, goedkeuren → factuurontwerp controleren.
- Later, niet gevraagd: privé-bioscoopzaal (kijkpagina met familielink), blijvend archief-belofte, herinneringsdatum-mail, fysiek aandenken, spoedoptie.
