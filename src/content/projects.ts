...
export const projects: Project[] = [
  ...
  },
  {
    ...
    year: "2026",
    blurb: "Staffing software for a prison workforce of two hundred, built inside the walls it serves.",
    tone: { base: "#0e1014", glow: "#7f96b8", light: "50% 85%" },
    nl: { category: "Maatsoftware", blurb: "Personeelsplanning voor een gevangenis met tweehonderd medewerkers, gebouwd binnen de muren die ze dient.", note: "Privé · een gesloten, beveiligde omgeving", },
