...
export default function Cursor() {
  ...
  return (
    <div aria-hidden="true" className="pointer-events-none fixed inset-0 z-[95]">
      <div
        ref={ringRef}
        className={`absolute top-0 left-0 flex -translate-x-1/2 -translate-y-1/2 items-center justify-center rounded-full transition-[width,height,background-color,border-color] duration-500 ease-out ${
          label
      ...
      <div
        ref={dotRef}
        className={`absolute top-0 left-0 h-1.5 w-1.5 -translate-x-1/2 -translate-y-1/2 rounded-full bg-champagne transition-opacity duration-300 ${
